...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'image_url' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'tags' => ['type' => 'string', 'length' => 1000, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'date_created' => '2017-02-23 07:33:08',
            'date_updated' => '2017-02-23 07:33:08',
            'category_id' => 1
        ],
    ];
}
